...
class StatusNotifier : public QObject, public IUKUIPanelPlugin
{
    Q_OBJECT
public:
    StatusNotifier(const IUKUIPanelPluginStartupInfo &startupInfo);
...
class StatusNotifierLibrary : public QObject, public IUKUIPanelPluginLibrary
{
    Q_OBJECT
