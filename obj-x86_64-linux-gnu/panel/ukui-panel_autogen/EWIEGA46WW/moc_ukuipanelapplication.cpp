...
void UKUIPanelApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<UKUIPanelApplication *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (UKUIPanelApplication::*)();
...
QT_INIT_METAOBJECT const QMetaObject UKUIPanelApplication::staticMetaObject = { {
    &UKUi::Application::staticMetaObject,
    qt_meta_stringdata_UKUIPanelApplication.data,
    qt_meta_data_UKUIPanelApplication,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *UKUIPanelApplication::qt_metacast(const char *_clname)
{
    ...
    return UKUi::Application::qt_metacast(_clname);
}

int UKUIPanelApplication::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = UKUi::Application::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 8)
