/****************************************************************************
** Meta object code from reading C++ file 'pluginsettings.h'
**
...
#error "The header file 'pluginsettings.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 31, 0) // ""
    ...
    "PluginSettings\0settingsChanged\0"
};
...
void PluginSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PluginSettings::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PluginSettings::settingsChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PluginSettings::settingsChanged()
{
