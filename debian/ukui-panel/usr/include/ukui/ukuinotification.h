...
#ifndef UKUINOTIFICATION_H
#define UKUINOTIFICATION_H
 ...
 */
class UKUI_API Notification : public QObject
{
    Q_OBJECT
public:
    /*!
    ...
    struct ServerInfo
    {
        ...
        QString name;
        //! The vendor name. For example, "ukui.org"
        QString vendor;
...
signals:
     ...
     */
    void notificationClosed(UKUi::Notification::CloseReason reason);
