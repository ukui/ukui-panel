...
struct _TestApplet {
	UkuiPanelApplet   base;
	GtkWidget    *label;
};

struct _TestAppletClass {
	UkuiPanelAppletClass   base_class;
};
...
test_applet_fill (TestApplet *applet)
{
	...
	test_applet_handle_size_change (applet,
					ukui_panel_applet_get_size (UKUI_PANEL_APPLET (applet)),
					NULL);
	test_applet_handle_orient_change (applet,
					  ukui_panel_applet_get_orient (UKUI_PANEL_APPLET (applet)),
					  NULL);
	...
	ukui_panel_applet_setup_menu (UKUI_PANEL_APPLET (applet),
	...
	ukui_panel_applet_set_flags (UKUI_PANEL_APPLET (applet), UKUI_PANEL_APPLET_HAS_HANDLE);
...
UKUI_PANEL_APPLET_OUT_PROCESS_FACTORY ("TestAppletFactory",
				  test_applet_get_type (),
				  "A Test Applet for the UKUI-3.0 Panel",
				  (UkuiPanelAppletFactoryCallback) test_applet_factory,
				  NULL)
