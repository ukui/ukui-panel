...
QLibrary* PluginInfo::loadLibrary(const QString& libDir) const
{
    ...
    const QString baseName = value(QL1S("X-UKUi-Library"), fi.completeBaseName()).toString();
 ...
 ************************************************/
QDebug operator<<(QDebug dbg, const UKUi::PluginInfo &pluginInfo)
{
 ...
 ************************************************/
QDebug operator<<(QDebug dbg, const UKUi::PluginInfo * const pluginInfo)
{
